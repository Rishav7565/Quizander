			    ...
			    if(ch==2)
		        	{
	                    ...
	                    printf("The total point is %d",t1);
			    ...
			    if(b1==1)
		        	{
				      t2=t2+1;
		        	printf("\nWOW, you answered it right. You have been awarded by 1 point\n");
	                    printf("The total point is %d",t2);
	                    printf("press enter to continue");
				     	fflush(stdin);
				     	getchar();
			        	system("cls");
...
{
	system("cls");
	printf(" Congratulation!\nYou have passed the Intermediate round\nThis the final Round. There will be 12 questions and you have to answer  10 questions correctly .\nThe time limit is 30 seconds.\nSo open you find and lets start the game.\n");
	getchar();
	system("cls");
}
else
			    ...
			    if(c1==2)
		        	{
				      t3=t3+1;
		        	printf("\nWOW, you answered it right. You have been awarded by 1 point\n");
	                    printf("The total point is %d",t3);
	                    printf("press enter to continue");
				     	fflush(stdin);
				     	getchar();
			        	system("cls");
